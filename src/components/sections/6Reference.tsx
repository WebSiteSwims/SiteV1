    ...
    <section className="w-full bg-[#f7f7f7] pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          ...
          <div className="text-4xl text-[#7b2ff2] mt-4 mb-8">
            <img src={guillemets} alt="Guillemets" className="w-8 h-8 inline-block" />
          </div>
          <div className="text-right text-[#222] font-semibold" style={{ 
            fontFamily: "'CO Text', Arial, sans-serif",
            fontSize: "clamp(16px, 2.5vw, 18px)"
          }}>
          </div>
